...
fig.add_trace(go.Scatter(x=[mean_of_sample1, mean_of_sample1], y=[0, 0.16], mode="lines", name="MEAN OF STUDENTS WHO HAD MATH LABS")) 
fig.add_trace(go.Scatter(x=[first_std_deviation_end, first_std_deviation_end], y=[0, 0.16], mode="lines", name="STANDARD DEVIATION 1 END")) 
fig.add_trace(go.Scatter(x=[second_std_deviation_end, second_std_deviation_end], y=[0, 0.16], mode="lines", name="STANDARD DEVIATION 2 END")) 
fig.add_trace(go.Scatter(x=[third_std_deviation_end, third_std_deviation_end], y=[0, 0.16], mode="lines", name="STANDARD DEVIATION 3 END")) 
fig.show()
...
print("The z score is 1 = ",z_score) 
z_score = (mean - mean_of_sample2)/std_deviation 
print("The z score is 2 = ",z_score) 
z_score = (mean - mean_of_sample3)/std_deviation 
print("The z score is 3 = ",z_score)